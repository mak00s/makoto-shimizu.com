...
- ２回閉じると、もう表示されなくなります
- ０〜１０の項目を選んで送信すると、KARTEとGoogle Analyticsの両方でデータが記録されます

## レポート

GAで計測されたイベントのデータを[毎時間自動更新するGoogle Sheet](https://docs.google.com/spreadsheets/d/14KiWRaWSqkPfXfxzTf5huk1u_MIJ1ITr_TJsgCjXaek/edit?usp=sharing)を作りました。
（まだ作業中）
